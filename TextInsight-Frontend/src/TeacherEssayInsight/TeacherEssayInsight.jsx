...
import styles from "./TeacherEssayInsight.module.css";

const TeacherEssayInsight = () => {
  ...
  const handleIntraEssayFeedback = () => {
    ...
    navigate("/teacherexploreinsight", {
      state: {
        title,
        feedbackData,
        feedbackType: "intra",
    ...
    <div className={styles["page-wrapper"]}>
      <div className={styles["essay-insight"]}>
        ...
        <div className={styles.header}>
          <h1 className={styles["main-title"]}>Feedback Overview</h1>
        ...
        <div className={styles["info-card"]}>
          ...
          Analyze Peer Comparison Feedback to Evaluate Student Performance Across Submissions.
          </p>
        </div>
...
export default TeacherEssayInsight;
