...
import styles from "./TeacherExploreInsight.module.css";

const TeacherExploreInsight = () => {
    ...
    <div className={styles["page-wrapper"]}>
      <div className={styles["explore-insight"]}>
        ...
        <div className={styles.header}>
          <h1 className={styles["main-title"]}>Feedback Overview and Management</h1>
        ...
        <div className={styles["info-card"]}>
          ...
          View automatically generated feedback for student submissions to guide improvement.
          </p>
        </div>
...
export default TeacherExploreInsight;
